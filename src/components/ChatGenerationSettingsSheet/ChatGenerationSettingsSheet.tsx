...
export const ChatGenerationSettingsSheet = observer(
  function ChatGenerationSettingsSheet({
    isVisible,
    onClose,
  }: {
    isVisible: boolean;
    ...
    const effectivePalId =
      session?.activePalId || chatSessionStore.newChatPalId;
              ...
              <SegmentedButtons
                ...
                onValueChange={async value => {
                  ...
                  if (session) {
                    ...
                    await chatSessionStore.updateSessionSettingsSource(
                      newSource,
                    );
                  } else {
